...
class TipsVideosAdapter(
    private val mContext: Context,
    private val list: List<Tips>,
    private val listener: TipsListener
) :
    RecyclerView.Adapter<TipsVideosAdapter.ViewHolder>() {

    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var imgPoster: ImageView = itemView.findViewById(R.id.image_video1)
        var txtTitle: TextView = itemView.findViewById(R.id.textView_video1)
        var imgAuthor: ImageView = itemView.findViewById(R.id.image_artist1)
        var txtAuthorName: TextView = itemView.findViewById(R.id.textView_artistName1)
        var txtPublishDate: TextView = itemView.findViewById(R.id.textView_publishVideoDate1)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val mView =
            LayoutInflater.from(mContext).inflate(R.layout.fragment_tips_videos, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.txtPublishDate.text = "2022"
